...
OUTPUT_DIR = "/media/yan/Data/dy_tmp_file/mount_6d/output"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    ...
    DET_FILES_TEST=(
        "/media/yan/Data/dy_tmp_file/mount_6d/BOP_DATASETS/ycbv/test/test_bboxes/fcos_V57eSE_MSx1333_ColorAugAAEWeaker_8e_ycbv_real_pbr_8e_test_keyframe.json",
    ),
...
INPUT = dict(
BG_IMGS_ROOT="/media/yan/Data/dy_tmp_file/mount_6d/VOCdevkit/VOC2012/",  # "datasets/coco/train2017/"
)
