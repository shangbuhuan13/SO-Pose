...
ren = EGLRenderer(
    model_paths, texture_paths=texture_paths, vertex_scale=0.001, use_cache=True, width=out_size, height=out_size
)
...
for d in tqdm(dset_dicts):
    ...
    ren.render(est_labels, est_poses, K=K_zoom, image_tensor=image_tensor, background=im_zoom_gray_3)
